...
def first_user():
    return User(
        ...
        task_list=[
            ...
            Task('Купить помидоры', 'Купить помидоры для салата', created_at='05.11.2024'),
        ]
    )
...
def task_with_runtime1():
    return Task('Купить помидоры', 'Купить помидоры для салата', created_at='15.10.2024', run_time=60)


@pytest.fixture
def task_with_runtime2():
    return Task('Купить перец', 'Купить перец для салата', created_at='15.10.2024', run_time=70)
